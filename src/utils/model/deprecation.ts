...
import { type BuiltinAPIProvider } from './configs.js'
...
type DeprecationEntry = {
  ...
  retirementDates: Record<BuiltinAPIProvider, string | null>
}
...
function getDeprecatedModelInfo(modelId: string): DeprecationInfo {
  ...
  const provider: BuiltinAPIProvider =
    apiProvider === 'openaiCompat' ? 'firstParty' : apiProvider
